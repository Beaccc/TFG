                ...
                <div class="content_block col-md-9 <?php echo esc_attr($frontech_float); ?> "><?php
                    ...
                    <div class="hm_blog_full_list hm_blog_list clearfix">
                        ...
                        <form action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="post"
                              id="form-elimina-videojuego" class="form-elimina-videojuego">

                            <label for="nombre">Selecciona el videojuego que deseas eliminar: </label>
                            <select id="videojuegos" name="videojuego-seleccionado" form="form-elimina-videojuego">
                                <?php
                            ...
                            <input type="hidden" name="action" value="eliminavideojuegoform">
