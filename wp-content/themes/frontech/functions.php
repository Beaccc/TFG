...
require '/Applications/MAMP/htdocs/wordpress/wp-content/themes/frontech/scripts/formulario.php';
require '/Applications/MAMP/htdocs/wordpress/wp-content/themes/frontech/scripts/formulario_nuevocriterio.php';
require '/Applications/MAMP/htdocs/wordpress/wp-content/themes/frontech/scripts/formulario_eliminacriterio.php';
require '/Applications/MAMP/htdocs/wordpress/wp-content/themes/frontech/scripts/formulario_nuevovideojuego.php';
require '/Applications/MAMP/htdocs/wordpress/wp-content/themes/frontech/scripts/formulario_eliminavideojuego.php';
require '/Applications/MAMP/htdocs/wordpress/wp-content/themes/frontech/scripts/rim.php';


function indi_admin_scripts() {
    wp_enqueue_style('indi-admin-css', '/Applications/MAMP/htdocs/wordpress/wp-content/themes/frontech/css/admin.css', true );
    wp_enqueue_script('indi-admin-js',  '/Applications/MAMP/htdocs/wordpress/wp-content/themes/frontech/css/admin.js', array('jquery'), true );
}
add_action('admin_enqueue_scripts', 'indi_admin_scripts');
